...
>
> **PLAN COMPLETO (Fases 1–4).** Follow-ups pendientes: compra pública de giftcard con Webpay (bloqueado: prod cobra de verdad, hay que decidir cómo probarlo) + canje en el checkout de reserva; segundo color de marca (accent); testimonios reales en landing. El canje en Caja quedó cerrado el 2026-07-22.
